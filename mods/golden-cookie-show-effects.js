// Show what effect the golden cookie will have.
// HACK: move choosing code to run when cookie is spawned rather than clicked, might have slight differences
...
Game.registerMod('richardsun29/cookie-clicker/mods/golden-cookie-show-effect',{
    init:function(){
        ...
        Game.shimmerTypes['golden'].popFunc = function(me) {
            ...
            {
                buff=Game.gainBuff('click frenzy',Math.ceil(13*effectDurMod),77777777);
            }
            else if (choice=='dragonflight')
            {
                buff=Game.gainBuff('dragonflight',Math.ceil(10*effectDurMod),111111111);
